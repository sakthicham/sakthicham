...
public class Client  implements ActionListener{
	...
	Client(){ 
		...
		ImageIcon icon1 = new ImageIcon("/Users/sakthivel/Downloads/Women.png");
		Image icon2 = icon1.getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT);
		ImageIcon icon3 = new ImageIcon(icon2);
	    JLabel pfp = new JLabel(icon3);
	    
	    ImageIcon icon4 = new ImageIcon("/Users/sakthivel/Downloads/close.png");
		...
		ImageIcon icon7 = new ImageIcon("/Users/sakthivel/Downloads/send.png");
